...
const errorSer = (numberOfError, typeOfDate, typeOfError, color) => {
...
const isDayCorrect = () => {
  if (day.value == "") {
    errorSer(0, day, typeOfError[1], "#ff5757");
    return false;
  } else if (day.value <= 0 || day.value > 31) {
    errorSer(0, day, typeOfError[2], "#ff5757");
    return false;
  } else if (isLeapYear(day.value, month.value, year.value) == false) {
    errorSer(0, day, typeOfError[5], "#ff5757");
    return false;
  } else {
    errorSer(0, day, typeOfError[0], "");
    return true;
  }
};
...
const isMonthCorrect = () => {
  if (month.value == "") {
    errorSer(1, month, typeOfError[1], "#ff5757");
    return false;
  } else if (month.value <= 0 || month.value > 12) {
    errorSer(1, month, typeOfError[3], "#ff5757");
    return false;
  } else if (isLeapYear(day.value, month.value, year.value) == false) {
    errorSer(1, month, typeOfError[0], "#ff5757");
    return false;
  } else {
    errorSer(1, month, typeOfError[0], "");
    return true;
  }
};
...
const isYearCorrect = () => {
  if (year.value == "") {
    errorSer(2, year, typeOfError[1], "#ff5757");
    return false;
  } else if (year.value > currentYear) {
    errorSer(2, year, typeOfError[4], "#ff5757");
    return false;
    ...
    errorSer(2, year, typeOfError[0], "#ff5757");
    return false;
  } else {
    errorSer(2, year, typeOfError[0], "");
    return true;
  }
};
